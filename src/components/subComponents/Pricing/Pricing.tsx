...
import GradientWrapper from "../../HeroPage/GradientWrapper";
            ...
            <div className="custom-screen gap-12 justify-between md:flex">
                ...
                <div className="mt-12 bg-white dark:bg-gray-900/50 rounded-xl shadow-lg md:mt-0">
                    <div className="h-full p-6 space-y-3">
                        ...
                        className="block w-full text-white bg-blue-600 dark:bg-sky-500 hover:bg-blue-500 dark:hover:bg-sky-600 ring-offset-2 ring-blue-600 dark:ring-sky-500 focus:ring shadow">
                            Get Started
                        </Button>
                    </div>
                </div>
