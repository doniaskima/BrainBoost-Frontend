import { LessonCardGrid } from "../subComponents/LessonCard/LessonCardGrid"
import SectionWrapper from "./SectionWrapper"
import lessonsExamples from "../../Lessons/lessons.json";
            ...
            <div className="custom-screen text-gray-600 dark:text-gray-300">
                <div className="max-w-xl space-y-3">
                    ...
                    BrainBoost is a leading provider of high-quality, affordable Computer Science education.{" "}
                        <a href="/tutorials/cs50" className="text-blue-600 hover:text-blue-400 dark:text-sky-500 dark:hover:text-sky-600 inline-flex items-center gap-x-1 duration-150">
                            Browse lessons
